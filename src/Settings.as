...
[Setting category="General" name="Override key" description="When pressed, the set speed limits are ignored, making the camera act as normal"]
VirtualKey S_Key = VirtualKey::C;
